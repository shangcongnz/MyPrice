...
/**
 * CountDown CommodityDetailCountdownExample
 * @author Cong_自动生成
 * @date 2021-09-01 17:45:36
 */
public class CommodityDetailCountdownExample {
    ...
    public CommodityDetailCountdownExample() {
    ...
    protected abstract static class GeneratedCriteria {
        ...
        public Criteria andShopCommondityIdNotBetween(Integer value1, Integer value2) {
		 ...
		 public Criteria andLikeQuery(CommodityDetailCountdown record) {
			...
			if(record.getImg()!=null&&StrUtil.isNotEmpty(record.getImg().toString())) {
    			 list.add("ifnull(img,'')");
    		}
