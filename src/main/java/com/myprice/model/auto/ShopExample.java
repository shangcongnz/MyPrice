...
public class ShopExample {
    ...
    protected abstract static class GeneratedCriteria {
        ...
        public Criteria andKeywordsNotBetween(String value1, String value2) {
		 ...
		 public Criteria andLikeQuery(Shop record) {
			...
			if(record.getShopName()!=null&&StrUtil.isNotEmpty(record.getShopName().toString())) {
    			 list.add("ifnull(shop_name,'')");
    		}
			...
			if(record.getWebsite()!=null&&StrUtil.isNotEmpty(record.getWebsite().toString())) {
    			 list.add("ifnull(website,'')");
    		}
			if(record.getHotline()!=null&&StrUtil.isNotEmpty(record.getHotline().toString())) {
    			 list.add("ifnull(hotline,'')");
    		}
			if(record.getKeywords()!=null&&StrUtil.isNotEmpty(record.getKeywords().toString())) {
    			 list.add("ifnull(keywords,'')");
    		}
			if(record.getId()!=null&&StrUtil.isNotEmpty(record.getId().toString())) {
    			list2.add("'%"+record.getId()+"%'");
    		}
			if(record.getShopName()!=null&&StrUtil.isNotEmpty(record.getShopName().toString())) {
    			list2.add("'%"+record.getShopName()+"%'");
    		}
			if(record.getDescription()!=null&&StrUtil.isNotEmpty(record.getDescription().toString())) {
			...
			if(record.getWebsite()!=null&&StrUtil.isNotEmpty(record.getWebsite().toString())) {
    			list2.add("'%"+record.getWebsite()+"%'");
    		}
			if(record.getHotline()!=null&&StrUtil.isNotEmpty(record.getHotline().toString())) {
    			list2.add("'%"+record.getHotline()+"%'");
    		}
			if(record.getKeywords()!=null&&StrUtil.isNotEmpty(record.getKeywords().toString())) {
    			list2.add("'%"+record.getKeywords()+"%'");
    		}
